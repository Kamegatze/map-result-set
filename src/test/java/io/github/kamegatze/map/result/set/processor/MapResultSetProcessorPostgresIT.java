...
import io.github.kamegatze.map.result.set.processor.university.mapper.CollectionMapper;
import io.github.kamegatze.map.result.set.processor.university.mapper.StudentClassMapper;
import io.github.kamegatze.map.result.set.processor.university.mapper.StudentClassNestedOneMapper;
import io.github.kamegatze.map.result.set.processor.university.mapper.StudentClassNestedTwoMapper;
import io.github.kamegatze.map.result.set.processor.university.mapper.StudentRecordMapper;
import io.github.kamegatze.map.result.set.processor.university.mapper.StudentRecordNestedOneMapper;
import io.github.kamegatze.map.result.set.processor.university.mapper.StudentRecordNestedTwoMapper;
...
class MapResultSetProcessorPostgresIT {
  ...
  @Test
  void givenStudentRecordFromCollectionMapper_whenQueryAllStudent_thenListStudent()
      throws SQLException {
    ...
    try (var connection = dataSource.getConnection();
      ...
      var students = mapper.toList(statement.getResultSet());

      assertNotNull(students);
      assertFalse(students.isEmpty());
      assertInstanceOf(List.class, students);
    }
  }
