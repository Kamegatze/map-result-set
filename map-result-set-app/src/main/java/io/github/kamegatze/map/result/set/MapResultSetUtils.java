...
import io.github.kamegatze.map.result.set.exceptions.ImpossibleCreateMapperException;
...
public final class MapResultSetUtils {
  ...
  public static <T> T getMapper(Class<T> tClass) {
    try {
      return (T)
          Class.forName(
                  tClass.getCanonicalName() + GeneralConstantUtility.POSTFIX_IMPLEMENT_INTERFACE)
